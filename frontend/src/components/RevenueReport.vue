  ...
  <div>
    <form>
      ...
      <b-row>
        ...
        <b-col cols="6">
          <h3>Rp.{{ report_data.total_revenue }}</h3>
        </b-col>
      </b-row>
      <br />
      <b-row>
        <vs-table striped>
          ...
          <template #tbody>
            ...
            <vs-tr>
              <vs-td>Pendapatan</vs-td>
              <vs-td>Rp.{{ report_data.n_rev }}</vs-td>
              <vs-td>Rp.{{ report_data.s_rev }}</vs-td>
              <vs-td>Rp.{{ report_data.g_rev }}</vs-td>
              <vs-td>Rp.{{ report_data.p_rev }}</vs-td>
            </vs-tr>
          </template>
        </vs-table>
      </b-row>
