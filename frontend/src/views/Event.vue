            ...
            <b-row>
              ...
              <b-col cols="5">
                <form class="purchase-form" @submit.prevent="pushOrderData">
                  ...
                  <b-row>
                    <b-col>
                      <h4>Total biaya : Rp. {{ total_cost }}</h4>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col>
    ...
    <template>
      <div class="center">
        <vs-dialog blur v-model="active_dialogue">
          <template #header>
            <h4 class="not-margin">Tiket berhasil dipesan!</h4>
          </template>
          <div>
            <img
              class="popup"
      ...
      <div class="center">
        <vs-dialog width="300px" not-center v-model="delete_confirm">
          ...
          <img
            ...
            alt=""
          />
          <h4>Yakin ingin menghapus event ini?</h4>
    ...
    <template>
      <div class="center">
        <vs-dialog blur v-model="delete_dialogue">
          <template #header>
            <h4 class="not-margin">Event berhasil dihapus!</h4>
          </template>
          <div>
            <img
              class="popup"
